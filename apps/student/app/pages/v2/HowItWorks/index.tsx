  ...
  const steps = [
    {
      ...
      description: 'Book a free consultation to discuss your goals. We\'ll recommend courses and universities that match your ambitions and budget.',
    ...
    },
    {
      ...
      description: 'Our MARA-registered agents prepare your application with precision. We handle everything from documentation to GTE statements.',
    ...
    },
    {
      ...
      description: 'Land in Australia with confidence. We support you with accommodation, part-time work, and pathways to permanent residency.',
